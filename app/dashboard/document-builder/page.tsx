  ...
  return (
    <DashboardShell>
      <div className="flex h-[calc(100vh-48px)]">
        {/* Left Sidebar */}
        <div className="w-[260px] bg-white border-r border-[#D5D9D5] flex flex-col flex-shrink-0 overflow-y-auto rounded-l-xl">
          <div className="px-4 py-4 border-b border-[#D5D9D5]">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="bg-white border-b border-[#D5D9D5] px-5 py-3 flex items-center justify-between flex-shrink-0">
            <div className="min-w-0">
              ...
              {selectedTemplate?.description && <p className="text-xs text-[#94A3B8] mt-0.5 truncate">{selectedTemplate.description}</p>}
            </div>
            {selectedTemplate && (
          ...
          {!selectedTemplate ? (
            <div className="flex-1 flex items-center justify-center bg-[#FBF9F4]">
              <div className="text-center">
                ...
                <p className="text-sm text-[#94A3B8] mt-1">Choose a document template from the sidebar to begin</p>
              </div>
            </div>
          ) : (
            <div className="flex-1 flex min-h-0">
              <div className="w-[340px] border-r border-[#D5D9D5] bg-white overflow-y-auto flex-shrink-0">
                <div className="px-4 py-3 border-b border-[#D5D9D5]">
                  <h3 className="text-sm font-semibold text-[#3A3F3A]">Fill in Details</h3>
                  <p className="text-xs text-[#94A3B8] mt-0.5">{placeholders.length} field{placeholders.length !== 1 ? 's' : ''}</p>
                </div>
