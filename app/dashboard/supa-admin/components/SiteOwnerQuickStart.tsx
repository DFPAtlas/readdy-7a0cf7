...
export default function SiteOwnerQuickStart({ overview, onNavigate }: SiteOwnerQuickStartProps) {
  ...
  const todos: DailyTodo[] = [
    {
      id: "compliance",
      label: "Review overdue compliance",
      detail: "Resolve expiring certificates and outstanding obligations",
      count: overview?.overdueCompliance.count ?? null,
      icon: "ri-shield-flash-line",
      color: "bg-[#EF4444]",
      tab: "compliance",
      urgent: (overview?.overdueCompliance.count ?? 0) > 0,
    },
    {
      id: "maintenance",
      label: "Check open maintenance jobs",
      detail: "Make sure contractors are assigned to active work",
      count: overview?.openMaintenanceJobs.count ?? null,
      icon: "ri-tools-line",
      color: "bg-[#F59E0B]",
      tab: "maintenance",
      urgent: (overview?.openMaintenanceJobs.count ?? 0) > 0,
    },
    {
      id: "arrears",
      label: "Review rent arrears",
      detail: "Follow up on overdue rent and payment issues",
      count: null,
